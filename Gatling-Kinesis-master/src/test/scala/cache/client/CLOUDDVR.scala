...
class CLOUDDVR(client : TvMetrixClient, listActions: List[String]) extends ISession{

	val utils =  new Utils()
 	var indexAction = 0
 	
 	val cloudDVR  = utils.getCloudDVR()
	...
	def buildPlay() :  String = {
		...
		content.put("contentId", cloudDVR.content.contentId)
		content.put("title", cloudDVR.content.title)
		content.put("duration", cloudDVR.content.duration)

		val channel : HashMap[String, Object] = new HashMap[String, Object]
		channel.put("serviceId", cloudDVR.channel.serviceId)
		channel.put("channelName", cloudDVR.channel.channelName)
		channel.put("channelNumber", cloudDVR.channel.channelNumber)

		val delivery : HashMap[String, Object] = new HashMap[String, Object]
		delivery.put("deliveryContext", cloudDVR.delivery.deliveryContext)
		delivery.put("serviceId", cloudDVR.delivery.serviceId)
		...
		vst.put("playRTSPTime"live, new Integer (random.nextInt(1000)))
